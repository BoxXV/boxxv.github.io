...
![Abc](https://boxxv.github.io/img/katakana-123/アイウ.png "Abc")

-----

`ア`    /a/    "underground"
![ア](https://boxxv.github.io/img/katakana/ア.png "ア")
```text
...
`イ`    /i/    "easel"
![イ](https://boxxv.github.io/img/katakana/イ.png "イ")
```text
...
`ウ`    u /ɯ/    "oodles"
![ウ](https://boxxv.github.io/img/katakana/ウ.png "ウ")
```text
...
`エ`    e /e/    "extra"
![エ](https://boxxv.github.io/img/katakana/エ.png "エ")
```text
...
`オ`    o /o/    "oh"
![オ](https://boxxv.github.io/img/katakana/オ.png "オ")
```text
...
`カ`    ka /ka/    "kite"
![カ](https://boxxv.github.io/img/katakana/カ.png "カ")
```text
...
`キ`    ki /ki/    "key"
![キ](https://boxxv.github.io/img/katakana/キ.png "キ")
```text
...
`ク`    ku /kɯ/    "quick" seven
![ク](https://boxxv.github.io/img/katakana/ク.png "ク")
```text
...
`ケ`    ke /ke/    K
![ケ](https://boxxv.github.io/img/katakana/ケ.png "ケ")
```text
...
`コ`    ko /ko/    "cold"
![コ](https://boxxv.github.io/img/katakana/コ.png "コ")
```text
...
`サ`    sa /sa/    "socks"
![サ](https://boxxv.github.io/img/katakana/サ.png "サ")
```text
...
`シ`    shi /ɕi/    "she"
![シ](https://boxxv.github.io/img/katakana/シ.png "シ")
```text
...
`ス`    su /sɯ/   "swing"
![ス](https://boxxv.github.io/img/katakana/ス.png "ス")
```text
...
`セ`    se /se/    "Senor"
![セ](https://boxxv.github.io/img/katakana/セ.png "セ")
```text
...
`ソ`    so /so/    "soy"
![ソ](https://boxxv.github.io/img/katakana/ソ.png "ソ")
```text
...
`タ`    ta /ta/    "Titanic"
![タ](https://boxxv.github.io/img/katakana/タ.png "タ")
```text
...
`チ`    chi /tɕi/    "chimp"
![チ](https://boxxv.github.io/img/katakana/チ.png "チ")
```text
...
`ツ`    tsu /tsɯ/    "peanuts"
![ツ](https://boxxv.github.io/img/katakana/ツ.png "ツ")
```text
...
`テ`    te /te/    "tail"
![テ](https://boxxv.github.io/img/katakana/テ.png "テ")
```text
...
`ト`    to /to/    "tomahawk"
![と](https://boxxv.github.io/img/katakana/ト.png "ト")
```text
...
`ナ`    na /na/    "number"
![ナ](https://boxxv.github.io/img/katakana/ナ.png "ナ")
```text
...
`ニ`    ni /ɲi/    "needles"
![ニ](https://boxxv.github.io/img/katakana/ニ.png "ニ")
```text
...
`ヌ`    nu /nɯ/    "new"
![ヌ](https://boxxv.github.io/img/katakana/ヌ.png "ヌ")
```text
...
`ネ`    ne /ne/    "never"
![ネ](https://boxxv.github.io/img/katakana/ネ.png "ネ")
```text
...
`ノ`    no /no/    "nose"
![ノ](https://boxxv.github.io/img/katakana/ノ.png "ノ")
```text
...
`ハ`    ha /ha/    "ha"
![ハ](https://boxxv.github.io/img/katakana/ハ.png "ハ")
```text
...
`ヒ`    hi /çi/    "heel"
![ヒ](https://boxxv.github.io/img/katakana/ヒ.png "ヒ")
```text
...
`フ`    fu /ɸɯ/    "hook"
![フ](https://boxxv.github.io/img/katakana/フ.png "フ")
```text
...
`ヘ`    he /he/    "haystack"
![へ](https://boxxv.github.io/img/katakana/%E3%83%98.png "へ")
```text
...
`ホ`    ho /ho/    "holy"
![ホ](https://boxxv.github.io/img/katakana/ホ.png "ホ")
```text
...
-----
`マ`    ma /ma/    "Martini"
![マ](https://boxxv.github.io/img/katakana/マ.png "マ")
```text
...
`ミ`    mi /mi/    3? "me"!
![ミ](https://boxxv.github.io/img/katakana/ミ.png "ミ")
```text
...
`ム`    mu /mɯ/    moo move
![ム](https://boxxv.github.io/img/katakana/ム.png "ム")
```text
...
`メ`    me /me/    "mended"
![メ](https://boxxv.github.io/img/katakana/メ.png "メ")
```text
...
`モ`    mo /mo/    "monitors"
![モ](https://boxxv.github.io/img/katakana/モ.png "モ")
```text
...
-----
`ヤ`    ya /ja/    "yacht"
![ヤ](https://boxxv.github.io/img/katakana/ヤ.png "ヤ")
```text
...
`ユ`    yu /jɯ/    "U-boat"
![ユ](https://boxxv.github.io/img/katakana/ユ.png "ユ")
```text
...
`ヨ`    yo /jo/    "yoga"
![ヨ](https://boxxv.github.io/img/katakana/ヨ.png "ヨ")
```text
...
-----
`ラ`    ra /ɾa/    "lantern"
![ラ](https://boxxv.github.io/img/katakana/ラ.png "ラ")
```text
...
`リ`    ri /ɾi/    "ribbon"
![リ](https://boxxv.github.io/img/katakana/リ.png "リ")
```text
...
`ル`    ru /ɾɯ/    "roots"
![ル](https://boxxv.github.io/img/katakana/ル.png "ル")
```text
...
`レ`    re /ɾe/    "let's"
![レ](https://boxxv.github.io/img/katakana/レ.png "レ")
```text
...
`ロ`    ro /ɾo/    "loaf"
![ロ](https://boxxv.github.io/img/katakana/ロ.png "ロ")
```text
...
`ワ`    wa /ɰa/    "wine"
![ワ](https://boxxv.github.io/img/katakana/ワ.png "ワ")
```text
...
`ヲ`    wo /o/    "wow"
![ヲ](https://boxxv.github.io/img/katakana/ヲ.png "ヲ")
```text
...
-----
`ン`    n /nn/    "mmm"
![ン](https://boxxv.github.io/img/katakana/ン.png "ン")
```text
