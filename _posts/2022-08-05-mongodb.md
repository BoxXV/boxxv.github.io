...
- Tải MongoDB từ link bên dưới: https://www.mongodb.org/downloads
- Chạy file vừa tải về
- Sau khi chạy xong file, vào thư mục C:\Program Files\MongoDB\Server\3.4\bin , chạy file mongod để khởi động mongoDB
...
## 9. Các kiểu dữ liệu trong MongoDB
