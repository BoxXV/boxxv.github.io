...
`あ` /a/ 	— Let's dig an underground tunnel! ア as in "underground".

         - Một cái ăng ten trên đỉnh mái. あ A hình giống như `A`ngten

![あ](http://boxxv.com/img/hiragana/a.png "あ")


`い` /i/ 	— I want an easel. イ as in "easel".

`い` /i/ 	— Có 2 con lươn `E`els
![い](http://boxxv.com/img/hiragana/i.png "い")


`う` u /ɯ/ 	— I have oodles of arrowheads. ウ as in "oodles".

`う` u /ɯ/ 	— `Ư` ư, kéo vật này thật nặng
![う](http://boxxv.com/img/hiragana/u.png "う")


`え` e /e/ 	— I have an extra bone. エ as in "extra".

`え` e /e/ 	— Chữ này giống người đang tập luyện thể dục
![え](http://boxxv.com/img/hiragana/e.png "え")


`お` o /o/ 	— Oh! What an odd kick! オ as in "oh".

`お` o /o/ 	— Quả bóng đang trên lỗ gôn
![お](http://boxxv.com/img/hiragana/o.png "お")

-----

`か` ka /ka/ 	— A kite is flying in the sky. カ as in "kite".

`か` ka /ka/ 	— Có cái diều trên trời
![か](http://boxxv.com/img/hiragana/ka.png "か")


`き` ki /ki/ 	— I have a key. キ as in "key".

`き` ki /ki/ 	— Chìa khóa. Ki là `Key`
![き](http://boxxv.com/img/hiragana/ki.png "き")


`く` ku /kɯ/ 		— This is a quick seven. ク as in "quick".

`く` ku /kɯ/ 		— Có con chim Cúc Cu. Mỏ chim kếu Kuc `Ku`
![く](http://boxxv.com/img/hiragana/ku.png "く")


`け` ke /ke/ 	— It's a crooked "K". ケ as in crooked "K".

`け` ke /ke/ 	— Có một két bia. Ke là `Két` bia
![け](http://boxxv.com/img/hiragana/ke.png "け")


`こ` ko /ko/ 	— I have a cold. コ as in "cold".

`こ` ko /kɔ:[r]/ 	— Có một lõi táo. Lõi táo là Core `Kɔ`
![こ](http://boxxv.com/img/hiragana/ko.png "こ")

-----

`さ` sa /sa/ 	— Let socks dry. サ as in "socks".

`さ` sa /sa/ 	— Tôi thích rượu Sake. Đây là mặt đang uống `Sa`ke
![さ](http://boxxv.com/img/hiragana/sa.png "さ")


`し` shi /ɕi/ 	— She has a crooked smile. シ as in "she".

`し` shi /ɕi/ 	— Cố ấy (She) có một mái tóc dài như chữa し
![し](http://boxxv.com/img/hiragana/shi.png "し")


`す` su /sɯ/ 	— My kid has a swing set. ス as in "swing".

`す` su /sɯ/ 	— Đuôi lợn xoáy tít như chữ Sư す
![す](http://boxxv.com/img/hiragana/su.png "す")


`せ` se /se/ 	— This is Senor Martines. セ asn in "Senor".

`せ` se /se/ 	— Đây là mặt của Senor Lopez. Giống chữ せ
![せ](http://boxxv.com/img/hiragana/se.png "せ")


`そ` so /so/ 	— A soy bean jumped out! ソ as in "soy".

`そ` so /so/ 	— Giống như những mũi khâu của máy khâu そ sewing /sō-iŋ/
![そ](http://boxxv.com/img/hiragana/so.png "そ")
