...
- Việc xuất bản mã JavaScript (không thể nói về các ngôn ngữ khác - hầu hết công việc của tôi là JavaScript và TypeScript) theo cách mà nhiều người có thể sử dụng được là một việc rất phức tạp và ngày càng trở nên tồi tệ hơn.
